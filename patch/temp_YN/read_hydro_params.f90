...
!                 print*, dtchimie,3.d0/50.d0
  ...
  if(barotrop .and. (.not. analytical_barotrop))then
     ...
     if(myid==1)write(*,*)'barotropic_eos.dat,nrho_barotrop,rhomin_barotrop,rhomax_barotrop,drho_barotrop',nrho_barotrop,rhomin_barotrop,rhomax_barotrop,drho_barotrop
...
!      open(14,file='verif.dat')
     ...
     if(myid==1)write(*,*)'tab_eos.dat,nRho,nEnergy,rhomin,rhomax,emin,Emax,yHe',nRho,nEnergy,rhomin,rhomax,emin,Emax,yHe
