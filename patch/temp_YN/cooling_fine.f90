...
subroutine pressure_eos(rho_temp,Enint_temp,Peos)
  ...
  ie = floor(le)
  write(*,*) 'inter_pressure =',ir,ie,rho,Enint,rho_temp,Enint_temp,scale_d,scale_v
  if  (ir < 1 .or. ie < 1 .or. ir>nrho .or. ie>nEnergy) then
     write(*,*) 'inter_pressure hors limite i,ir,ie = ',ir,ie,rho,Enint,rho_temp,Enint_temp,scale_d,scale_v 
     ir=1.0d0
     ie=1.0d0
     stop
  endif
