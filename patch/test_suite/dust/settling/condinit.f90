...
#endif
     q(i,1)=max(rho_sim*exp(-abs(xx**2/(2.0d0*H_disc**2)))/(1.0d0-sum_dust),smallr)+1.d-20/scale_d
     q(i,5)= q(i,1)*(1.0d0-sum_dust)*cs**2
     q(i,2)= 0.0d0
     q(i,3)= 0.0d0
     q(i,4)= 0.0d0    
