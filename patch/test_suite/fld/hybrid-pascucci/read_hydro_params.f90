subroutine read_hydro_params(nml_ok)
  ...
  namelist/boundary_params/nboundary,bound_type &
       ...
       & ,var_bound &
#endif
       & ,d_bound,u_bound,v_bound,w_bound,p_bound,T_bound,no_inflow &
#if NENER>NGRP
       & ,prad_bound &
#endif
#if NGRP>0
...
!       & ,rsink_max,msink_max,merge_stars &
  ...
  namelist/radiation_params/grey_rad_transfer,dtdiff_params,dt_control &
       ...
       & ,numin,numax,Tr_floor,robin,opacity_type,rad_trans_model,min_optical_depth,rt_feedback &
       ...
       & ,sinks_opt_thin,stellar_photon,Tstar,rstar,test,rho_disk0,Rin,isoscat
  ! modif nimhd
