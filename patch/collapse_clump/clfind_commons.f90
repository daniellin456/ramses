...
!  integer,dimension(1:1064,1:1064)::npeak_alltoall
!  integer,dimension(1:1064,1:1064)::npeak_alltoall_tot

  !PH move them here from  build_peak_communicator as it induces a segfault in OCCIGEN for ncpu > 1000
  !12/01/2021
