...
!       & ,rsink_max,msink_max,merge_stars &
  ...
  namelist/dust_params/grain_size, grain_dens, K_dust, K_drag,dust_diffusion_test,slope_dust,dust_ratio,mrn, size_min, size_max, mrn_index&
       &,reduce_wdust,reduce_tstop,vdust_max,kwok_correction, vmax_barycenter, f_vmax ,vmax_cs,vmax_dust_lim ,update_eint, smalleps,courant_factor_dust,dust_not_pscal &
       &,dust_growth,smoluchowski,stepinski,charged_dust_dynamics,v_frag,bifluid
#endif
  ! Read namelist file
  rewind(1)
