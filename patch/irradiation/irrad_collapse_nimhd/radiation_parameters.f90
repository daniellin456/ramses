...
function planck_ana(dens,Tp,Tr,igroup,insink)
  ...
  if (sinks_opt_thin==.true. .and. insink==.true.) planck_ana = min_optical_depth/(0.5D0**nlevelmax*boxlen*scale_l)
...
function rosseland_ana(dens,Tp,Tr,igroup,insink)
  ...
  if (sinks_opt_thin==.true. .and. insink==.true.) rosseland_ana = min_optical_depth/(0.5D0**nlevelmax*boxlen*scale_l)
