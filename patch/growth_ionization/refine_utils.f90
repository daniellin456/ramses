  ...
  if(.not.init .and. .not.balance)then
     ...
     if(hydro)then
        do j=0,twondim
           ...
           do idim=1,ndim
              do idust=1,ndust
                 do i=1,nn
                    u1dust(i,j,ndim*(idust-1)+idim)=v_dust(ind_fathers(i,j),idust,idim)
                 end do
              end do
           end do
#endif           
...
#endif
#if NDUST>0       
        call interpol_hydro_dust(u1dust,ind1,u2dust,nn)
#endif        
        ...
        do j=1,twotondim
           ...
           do idim=1,ndim
              do idust=1,ndust
                 do i=1,nn
                    v_dust(iskip+ind_grid_son(i),idust,idim)=u2dust(i,j,ndim*(idust-1)+idim)
                 end do
              end do
           end do
#endif           
     ...
     do j=1,twotondim
        ...
        do idust=1,ndust
           do idim=1,ndim
              do i=1,nn
                 v_dust(iskip+ind_grid_son(i),idust,idim)=v_dust(ind_fathers(i,0),idust,idim)
              end do
           end do
        end do
     end do
