module hydro_commons
  ...
  real(dp),allocatable,dimension(:,:)::table_coag ! Abundance table for coagulation
#if ICOAG>0  
  real(dp),allocatable,dimension(:):: grain_size,grain_cross,grain_mass,grain_abund ! Abundance table for coagulation
#endif  
#if NDUST>0
