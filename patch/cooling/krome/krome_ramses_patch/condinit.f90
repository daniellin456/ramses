...
subroutine condinit(x,u,dx,nn)
  ...
  if(krome_chem)then
    ...
    q(1:nn,ndim+2+4)  = 0.24375  !HE
    q(1:nn,ndim+2+5)  = 1.5123d-06  !H2
    q(1:nn,ndim+2+6)  = 8.1967d-05  !H+
    q(1:nn,ndim+2+7)  = 1d-40  !HE+
    q(1:nn,ndim+2+8)  = 1d-40  !H2+
    q(1:nn,ndim+2+9)  = 1d-40  !HE++
