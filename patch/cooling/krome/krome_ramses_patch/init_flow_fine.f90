  ...
  if(ok_file)then
    ...
    do ivar=1,nvar
      ...
      if(krome_chem) then
        ...
        if(ivar==ndim+2+1)  init_array = 4.4983e-08  !E
        if(ivar==ndim+2+2)  init_array = 1e-40  !H-
        if(ivar==ndim+2+3)  init_array = 0.75615  !H
        if(ivar==ndim+2+4)  init_array = 0.24375  !HE
        if(ivar==ndim+2+5)  init_array = 1.5123e-06  !H2
        if(ivar==ndim+2+6)  init_array = 8.1967e-05  !H+
        if(ivar==ndim+2+7)  init_array = 1e-40  !HE+
        if(ivar==ndim+2+8)  init_array = 1e-40  !H2+
        if(ivar==ndim+2+9)  init_array = 1e-40  !HE++
