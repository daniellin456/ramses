        ...
        do j=jlo,jhi
           do i=if1,if2
              do l=1,ngrid
                 ...
                 if(energy_fix)flux(l,i,j,k,nvar,1)=flux(l,i,j,k,nvar,1)+(fluxambdiff(l,i,j,k,1)+fluxohm(l,i,j,k,1) )*dt/dx
        ...
        do j=jf1,jf2
           do i=ilo,ihi
              do l=1,ngrid
                 ...
                 if(energy_fix)flux(l,i,j,k,nvar,2)=flux(l,i,j,k,nvar,2)+(fluxambdiff(l,i,j,k,2)+fluxohm(l,i,j,k,2) )*dt/dy
        ...
        do j=jlo,jhi
           do i=ilo,ihi
              do l=1,ngrid
                 ...
                 if(energy_fix)flux(l,i,j,k,nvar,3)=flux(l,i,j,k,nvar,3)+(fluxambdiff(l,i,j,k,3)+fluxohm(l,i,j,k,3) )*dt/dz
...
!#if NEXTINCT > 0
            !ionisrate=0.25*(q(l,i,j,k,8+nrad+nextinct)+q(l,i-imm1,j-jmm1,k,8+nrad+nextinct)+q(l,i-imm1,j,k-kmm1,8+nrad+nextinct)+q(l,i,j-jmm1,k-kmm1,8+nrad+nextinct))
!#else
            !ionisrate=default_ionisrate
!#endif
            ionisrate=1d-17
